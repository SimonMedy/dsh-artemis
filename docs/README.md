...
- [`product-vision.md`](product-vision.md): product value, user workflows and the mobile computer-use / visual-observation direction.
...
- [`snapshot-observation.md`](snapshot-observation.md): Phase 1.5 ephemeral Android snapshot contract, security invariants and model-handoff gate.
- [`live-viewer.md`](live-viewer.md): Phase 2 human live-screen transport, backpressure, lifecycle and privacy guarantees.

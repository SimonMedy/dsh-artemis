...
test('literal-loopback policy composes with the existing base URL falidation', () => {
...
test('product client factory rejects malformed options rather than coercing them', () => {
  assert.throws(() => createProductArtemisBttpClient(null), /options must be an object/)
